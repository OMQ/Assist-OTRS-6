# VERSION:1.1
# --
# Kernel/Config/Files/ZZZOmqAssistRepository.pm - Add online package repository
...
package Kernel::Config::Files::ZZZOmqAssistRepository;
...
sub Load {
    ...
    my $RepositoryBase = 'https://s3.eu-central-1.amazonaws.com/omq-otrs-packages/otrs-6/';
    ...
    # specify branch (develop|public) // replaced by build server DO NOT CHANGE
    my $RepositoryBranch = 'develop';

    # build url
    my $RepositoryURL = $RepositoryBase . $RepositoryBranch;
